...
def int_check():
    """Checks users enter an integer more than / equal 13"""
...
def initial_points(which_player):
    ...
    # Roll the dice for the user and note if they go double
...
while comp_score < game_goal and user_score < game_goal:
    ...
    # if the computer has fewer points, witch the computer to 'player 1'
    else:
